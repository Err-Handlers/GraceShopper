...
const Products = ({token, isAdmin, productToEdit, cart, setCart, setProducts, products, fetchProducts, guestCart, setGuestCart, error}) => {
    ...
    <>
        ...
        {filteredProducts.map( product => { 
            return(
                ...
                setProducts={setProducts} fetchProducts={fetchProducts} product={product} key={product.id} guestCart={guestCart} setGuestCart={setGuestCart} error={error}/>
            )
        } 
        )}
